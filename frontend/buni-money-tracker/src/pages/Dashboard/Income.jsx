...
import { FiArrowLeft, FiTrendingUp, FiTrash2 } from "react-icons/fi";
      ...
      <div className="space-y-8">
        ...
        <div className="flex items-center justify-between ios-fade-in">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-display text-3xl font-bold text-white">Income</h1>
              <p className="text-body text-white/70">Track your income sources</p>
            </div>
          </div>
          <div className="text-right">
            <p className="text-body text-sm text-white/70">Total Income</p>
            <p className="text-display text-2xl font-bold text-green-400">{formatCurrency(totalIncome)}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="glass-card rounded-2xl p-6 ios-slide-up" style={{ animationDelay: '0.2s' }}>
            <h2 className="text-display text-lg font-semibold text-white mb-6">Add New Income</h2>
          ...
          <div className="glass-card rounded-2xl ios-slide-up" style={{ animationDelay: '0.3s' }}>
            <div className="p-6 border-b border-white/20">
              <h2 className="text-display text-lg font-semibold text-white">Recent Income</h2>
            </div>
            <div className="p-6">
              {loading ? (
                ...
                <div className="text-center py-8">
                  <FiTrendingUp className="mx-auto text-white/40 mb-4" size={48} />
                  <p className="text-body text-white/70">No income transactions yet</p>
                  <p className="text-body text-sm text-white/50">Add your first income above</p>
                </div>
              ) : (
                  ...
                  {transactions.map((transaction) => (
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-4">
                        <span className="text-display font-semibold text-green-400">
